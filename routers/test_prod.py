...
import base64
from config import URL_TOKEN_PROD, AUTH_PROD, URL_SERVICIO_PROD


url_token = URL_TOKEN_PROD
auth = AUTH_PROD
url_servicio = URL_SERVICIO_PROD
...
def ejecutar_test_hml(res):
    res.append(test_buscarDetallePorNumero('IF-2021-31350215-GDEBA-TESTGDEBA'))
    res.append(test_buscarDocumentoEnExpedientess('IF-2021-31350215-GDEBA-TESTGDEBA'))
    res.append(test_buscarDocumentoPublicablePorNumero('IF-2021-31350215-GDEBA-TESTGDEBA'))
    res.append(test_buscarNumeroGDEBA('procesoGEDO.1744335941'))
    res.append(test_buscarPDFPorNumero('IF-2021-31350215-GDEBA-TESTGDEBA'))
    res.append(test_buscarPorNumero('IF-2021-31350215-GDEBA-TESTGDEBA'))
    res.append(test_buscarPorCuitCuil('20367180162'))
    res.append(test_buscarPorUsuario('USERT'))
    res.append(test_buscarPorNombre('FFCC_CV_Solicitud GDEBA_V5'))
    res.append(test_consultarTipoDocumento('TESTL'))
    ...
    res.append(test_consultarCaratulaVariablePorNumeroExpedienteUsuario('EX-2018-11123159- -GDEBA-DGAOPDS'))
    res.append(test_buscarCaratulaPorNumeroExpediente('EX-2018-11123159- -GDEBA-DGAOPDS'))
    res.append(test_consultarIdFCPorNumeroExpediente('EX-2020-20468158- -GDEBA-DSTAMJGM'))
    res.append(test_buscarHistorialPasesExpediente('EX-2018-11123159- -GDEBA-DGAOPDS'))
    res.append(test_buscarExpedientesPorSistemaOrigenUsuario('USERT'))
    res.append(test_buscarExpedientePorIdSistemaExterno(0))
    res.append(test_buscarExpediente('EX-2021-30347340-   -GDEBA-TESTGDEBA'))
    res.append(test_consultarExpedienteDetallado('EX-2021-30347340-   -GDEBA-TESTGDEBA'))
    res.append(test_buscarCodigoCaratulaPorNumeroExpediente('EX-2021-32524235- -GDEBA-TESTGDEBA'))
    res.append(test_buscarDatosExpedienteVariable('EX-2020-20468158- -GDEBA-DSTAMJGM'))
    res.append(test_validarExpediente('EX-2021-32524235- -GDEBA-TESTGDEBA'))
    ...
    res.append(test_consultaEstadoActualExpediente('EX-2021-30347340-   -GDEBA-TESTGDEBA'))
    res.append(test_consultaEstadosPaseExpedientePosibles('EX-2021-30347340-   -GDEBA-TESTGDEBA'))
    res.append(test_esEstadoPaseExpedienteValido('EX-2021-30347340-   -GDEBA-TESTGDEBA'))
    ...
    res.append(test_vincularDocumentosOficialesConNumeroEspecial(expediente1, 'DIFST-2021-9-GDEBA-TESTGDEBA'))
    res.append(test_desvincularDocumentosOficialesConNumeroEspecial(expediente1, 'DIFST-2021-9-GDEBA-TESTGDEBA'))
...
@router.get('/test_servicios/test_prod', tags=['test_prod'])
def test_hml():
    resultado = []
    ejecutar_test_hml(resultado)
    return {'test_prod': resultado}